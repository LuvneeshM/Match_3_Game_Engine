...
print ("Max Position: {}".format(mcts_points_list.index(max(mcts_points_list))))
print ("Random score at postion: {}".format( random_points_list[mcts_points_list.index(max(mcts_points_list))] ))
...
print ("Max Position: {}".format(random_points_list.index(max(random_points_list))))
print ("Random score at postion: {}".format( mcts_points_list[random_points_list.index(max(random_points_list))] ))
